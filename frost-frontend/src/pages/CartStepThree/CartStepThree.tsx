...
import {BASKET_ROUTE_STEP_FOUR} from "../../utils/consts";
const CartStepThree: React.FC = () => {
    ...
    const UpdateData = () => {
        ...
        if(token){
            addOrUpdateOrder({
                ...
                res=>{
                    navigate(BASKET_ROUTE_STEP_FOUR)
                }
            )
                .catch(e=>{
                    console.log(e)
    ...
    return (
        <section className="preparation">
            <div className="container preparation-container delivery-container">
                <div className="top-container top-container-2">
                    ...
                    <div className="stage-box">
                        ...
                        <div className="stage stage-2-192">
                            <div className="sq">Контактные данные</div>
                            <div className="rec rec-standart rec-2"></div>
                        </div>
                        <div className="stage stage-3-z">
                            <div className="sq sq-active">Доставка</div>
                            <div className="rec rec-3"></div>
                        </div>
                        <div className="stage stage-4-618">
                    ...
                    <div className='contact-container'>
                        ...
                        <button onClick={UpdateData} className="checkout-btn btn-blue-effect btn-blue-effect-btn">Оформить заказ</button>
                </div>
